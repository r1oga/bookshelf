...
describe('smoke', () => {
  it('should allow a typical user flow', () => {
    ...
    cy.findByRole('main').within(() => {
      cy.findByRole('searchbox').type('voice of war{enter}')
    ...
    cy.findByRole('main').within(() => {
      cy.findAllByRole('textbox', { name: /notes/i }).type('awesome book')
    ...
    cy.findByRole('main').within(() => {
      cy.findByRole('button', { name: /mark as unread/i }).click()
